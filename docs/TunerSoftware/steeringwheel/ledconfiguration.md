!!! info "Connecting through Simucube 2 Wheelbase"
    To use this feature you will need to connect the wireless wheel via Simucube Link Hub,
    a separate device, instead through the Simucube 2. You can find the Simucube Link Hub 
    from our store page [here](https://simucube.com/link-hub/){ target="_blank" }.
...
![](assets/tuner3_steeringwheel_savupro_ledview.png)
...
![](assets/tuner3_steeringwheel_savupro_ledview__telemetry_edit.png)
...
![](assets/tuner3_steeringwheel_savupro_ledview__telemetry_edit_add_duplicate_effect.png)

- The right-side panel is effect list and is in hierarchical order starting from the top.
    - Click any of the effects to select it, it will become highlighted with gray color.
