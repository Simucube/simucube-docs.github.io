...
<br>
The damper is bolted, rod end rearwards to the Co-Pedal shell frame and lever. Bolts, spacer and washers (excluding 4mm front spacer) are installed as shown in the picture below. The bolts are then fastened to place with the allen key included in the package.
<br>
<br>

![](assets/damper_light.svg#gh-light-mode-only){width="700"}
![](assets/damper_dark.svg#gh-dark-mode-only){width="700"}
