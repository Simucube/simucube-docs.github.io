![](assets/SC2AdapterInstalledLight.svg#gh-light-mode-only){ width="450" }
![](assets/SC2AdapterInstalledDark.svg#gh-dark-mode-only){ width="450" }
...
![](assets/SC2AdapterWhatsIncludedLight.svg#gh-light-mode-only){ width="600" }
![](assets/SC2AdapterWhatsIncludedDark.svg#gh-dark-mode-only){ width="600" }

| Item                     | Qty   |
| ------------------------ | ----- |
| 1. Link Quick Release male side     | 1 pc  |
| 2. Simucube 2 - Link Quick Release Adapter      | 1 pc  |
| 3. Fastener kit <br> &ensp; &ensp; - M5x20 hex head screw <br> &ensp; &ensp; - M5x12 hex head countersunk screw <br> | <br> 4 pcs <br> 3 pcs |
| 3. Tool kit <br> &ensp; &ensp; - L-key 4 mm Hex <br> &ensp; &ensp; - L-key 3 mm Hex <br> | <br> 1 pcs <br> 1 pcs |
...
![](assets/SC2AdapterStep1.svg){width=650}
...
![](assets/SC2AdapterStep2.svg){width=650} 
...
![](assets/SC2QRAdapterStep1.svg){width=650}
...
![](assets/SC2QRAdapterStep2.svg){width=650}
...
![](assets/SC2QRAdapterStep3.svg){width=650}
